<%@ Page Title="" Language="C#" MasterPageFile="Default.Master" AutoEventWireup="true" CodeBehind="TraceLocation.aspx.cs" Inherits="_3Tier.TraceLocation" %>
    ...
    <table class="body">
     ...
     <tr>
                <td class="body2" align="center" width="100%" >
                    <table width="80%" align="center" height="70%">
                        <tr>
                            <td id="map_canvas" style="width:80%; height: 500px;text-align:center;"></td>
                        </tr>
                    </table>
                </td>
            </tr>
