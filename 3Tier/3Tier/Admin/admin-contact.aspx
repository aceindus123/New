<%@ Page Language="C#" AutoEventWireup="true" CodeFile="admin-contact.aspx.cs" Inherits="_3Tier.Admin.admin_contact" %>
        ...
        <table width="100%" border="0" align="center">
            ...
            <tr>
                           ...
                           <tr><td><br /></td></tr>
                            <tr>
                              <td align="center" id="View" runat="server"  Width="100%" >
                               <font size="5" color="#00277a"><strong>Contact Us  </strong></font>
                              </td>
                          </tr>
                                   ...
                                   <HeaderStyle Font-Bold="True"  ForeColor="#003399" Height="30px" BackColor="#bfbfbf" Font-Size="14px" Font-Names="Arial" /> 
                                    <Columns>
                                      ...
                                      <asp:Label ID="linkname" runat="server" CssClass="simple1"  
                                         Text='<%# Eval("fname") %>'   Font-Underline="false"></asp:Label>
                                      </ItemTemplate>                     
                                      </asp:TemplateField>
                                      ...
                                      <ItemStyle ForeColor="Gray" BorderColor="#CCCCCC" HorizontalAlign="Center"/>
                                      <ItemTemplate><asp:Label ID="lblpno1" runat="server" Text='<%# Eval("phonemumber") %>' /></ItemTemplate>
                                      </asp:TemplateField>

                                         <asp:TemplateField>
                                      <HeaderTemplate>Comments</HeaderTemplate>
                                      <ItemStyle ForeColor="Gray" BorderColor="#CCCCCC" HorizontalAlign="Center"/>
                                      <ItemTemplate><asp:Label ID="lblpno2" runat="server" Text='<%# Eval("Comments") %>' /></ItemTemplate>
                                      </asp:TemplateField>
                                      ...
                                      <ItemStyle ForeColor="Gray" BorderColor="#CCCCCC" HorizontalAlign="Center"/>
                                      <ItemTemplate><asp:Label ID="lblpdate" runat="server" Text='<%# Eval("date") %>' /></ItemTemplate>
                                      </asp:TemplateField>
                                     ...
                                     <ItemTemplate>
                                         <asp:LinkButton ID="linkactive" runat="server" CssClass="simple1"  Text="Send Email"
                                              CommandArgument='<%#Eval("cid") %>' OnCommand="ListName1" Font-Underline="false"></asp:LinkButton></ItemTemplate>
                                     </asp:TemplateField>
                                     ...
                                     <ItemTemplate>
                                         <asp:LinkButton ID="lnkdelete" runat="server"  CssClass="simple1" 
                                              CommandArgument='<%#Eval("cid") %>' OnCommand="ListName2"  Font-Underline="false"
              ...
              <div id="updateclient" runat="server">    
                  <asp:Panel runat="server" ID="pnledit" Width="800px" Height="300px" BorderColor="Black"   HorizontalAlign="Center" BackColor="#E6E6E6" Visible="false" >
                         <table width="100%"> 
                            <tr>
                                  <td width="100%">
