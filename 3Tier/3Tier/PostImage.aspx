<%@ Page Title="" Language="C#" MasterPageFile="Default.Master" AutoEventWireup="true" CodeBehind="PostImage.aspx.cs" Inherits="_3Tier.PostImage" %>
    ...
    <ajx:ToolkitScriptManager ID="as" runat="server"></ajx:ToolkitScriptManager>
     ...
     <table width="100%" align="center">
          <tr>
             ...
             <tr>
                <td valign="top" colspan="3" width="20%" align="center">
         ...
         <tr>
               <td align="center" width="100%"  >
                     <asp:DataList ID="ddtop" runat="server" width="50%"  RepeatColumns="1"  BorderStyle="Dashed" BorderWidth="1"
                                                        CellPadding="1" CellSpacing="0" >
                                             <ItemTemplate>
                                               <table width="100%"  align="center" class="body2"   >
                                                   <tr>
                                                      <td align="center"  >
         ...
         <tr>
               <td align="center" >
                     <asp:DataList ID="DataList1" runat="server" width="50%"  RepeatColumns="1"  BorderStyle="Dashed" BorderWidth="1"
                                                        CellPadding="1" CellSpacing="0" >
                                             <ItemTemplate>
                                               <table  width="100%"  align="center" class="body2"   >
                                                   <tr>
                                                      <td align="center"  >
                                                         <asp:Image runat="server"  ID="Label11"  ImageUrl='<%#"ImageHandler1.ashx?imgID="+ Eval("sid") %>'  
                                                             Height="300px" Width="300px" />
                                                      </td>
                                                  </tr>
                                              </table>
         ...
         <tr>
               <td align="center" >
                     <asp:DataList ID="DataList2" runat="server" width="50%"  RepeatColumns="1"  BorderStyle="Dashed" BorderWidth="1"
                                                        CellPadding="1" CellSpacing="0" >
                                             <ItemTemplate>
                                               <table width="100%"  align="center"  class="body2"  >
                                                   <tr>
                                                      <td align="center"  >
                                                         <asp:Image runat="server"  ID="Label12"  ImageUrl='<%#"ImageHandler2.ashx?imgID="+ Eval("sid") %>'  
                                                             Height="300px" Width="300px" />
                                                      </td>
                                                  </tr>
                                              </table>
         ...
         <tr>
               <td align="center" >
                     <asp:DataList ID="DataList3" runat="server" width="50%"  RepeatColumns="1"  BorderStyle="Dashed" BorderWidth="1"
                                                        CellPadding="1" CellSpacing="0" >
                                             <ItemTemplate>
                                               <table  width="100%"  align="center" class="body2"   >
                                                   <tr>
                                                      <td align="center"  >
                                                         <asp:Image runat="server"  ID="Label13"  ImageUrl='<%#"ImageHandler3.ashx?imgID="+ Eval("sid") %>'  
                                                             Height="300px" Width="300px" />
                                                      </td>
                                                  </tr>
                                              </table>
         ...
         <tr>
               <td align="center" >
                     <asp:DataList ID="DataList4" runat="server" width="50%"  RepeatColumns="1"  BorderStyle="Dashed" BorderWidth="1"
                                                        CellPadding="1" CellSpacing="0" >
                                             <ItemTemplate>
                                               <table  width="100%"  align="center" class="body2"   >
                                                   <tr>
                                                      <td align="center"  >
                                                         <asp:Image runat="server"  ID="Label14"  ImageUrl='<%#"ImageHandler4.ashx?imgID="+ Eval("sid") %>'  
                                                             Height="300px" Width="300px" />
                                                      </td>
                                                  </tr>
                                              </table>
         ...
         <tr>
               <td align="center" >
                     <asp:DataList ID="DataList5" runat="server" width="50%"  RepeatColumns="1"  BorderStyle="Dashed" BorderWidth="1"
                                                        CellPadding="1" CellSpacing="0" >
                                             <ItemTemplate>
                                               <table  width="100%"  align="center" class="body2"   >
                                                   <tr>
                                                      <td align="center"  >
                                                         <asp:Image runat="server"  ID="Label15"  ImageUrl='<%#"ImageHandler5.ashx?imgID="+ Eval("sid") %>'  
                                                             Height="300px" Width="300px" />
                                                      </td>
                                                  </tr>
                                              </table>
