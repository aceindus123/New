<%@ Page Title="" Language="C#" MasterPageFile="Default.Master" AutoEventWireup="true" CodeBehind="AboutUs.aspx.cs" Inherits="_3Tier.AboutUs" %>
         ...
         <tr class="body2">
                <td  align="center" width="100%">
                       <table   align="center" width="70%">
                            <tr>
                                  <td style="height:450px;" align="center" valign="top" class="shadow" >
                                      <p style="text-align:left;padding-left:50px;padding-right:50px;position:relative;font:15px arial;padding-top:20px; text-align:justify;" >
                                            <span style="text-align:center;font:20px arial;padding-left:300px;"><b>About Us</b></span><br /><br />
                                          INDUS is a free classified ads website, where as a seller you can sell a range of products such as mobiles,
                                           smart phones, cars and bikes, tablets, electronics and computers, animals/pets, books, fashion apparels
                                           which are generally used by a huge lot. As we have got a network for which our team has researched and
                                           made associations, so that the result in terms of business transactions can be adequate. Sellers can
                                           easily post their ads in the particular category that matches with their product.
                                           A Buyer can go through various items and purchase those which they are interested in. The technical development
                                           team has taken into consideration all the aspects that goes on in building a great classifieds website. Both Buyers
                                           and sellers can easily buy and sell products and services, and upon that we have focused on building 
                                          this site keeping into perspective the precise demands of Buyers and Sellers
                                      </p>
                                 </td>
                            </tr> 
                        </table>
