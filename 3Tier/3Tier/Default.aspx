<%@ Page Title="" Language="C#" MasterPageFile="Default.Master" AutoEventWireup="true"  CodeBehind="Default.aspx.cs" Inherits="_3Tier.Default1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table class="body">
          ...
          CancelControlID="Button3" DropShadow="false" PopupControlID="pnlAtoZ"></ajx:modalpopupextender>
            ...
            <tr>
                <td width="100%" align="left" valign="top" style="position:relative;">
                    <table width="100%">
                        <tr>
                           <td align="center" width="75%">
                                <asp:DataList ID="ddtop" runat="server" width="100%"  RepeatColumns="5" 
                             ...
                             <ItemTemplate>
                               ...
                               <table width="100%"  align="center"  >
                                  ...
                                  <tr>
                                      <td  align="center"  >  
                                        <asp:LinkButton ID="lbltitle" runat="server" Text='<%# Eval("Category") %>'   Font-Underline="false" Font-Names="arial" Font-Size="15px"
              ...
              <tr class="body2" id="downdata" runat="server">
                <td  width="100%" align="left" valign="top">
                    <table width="100%" style="border: 0px solid #3da6d6">
                        <tr>
                            <td align="center" width="80%" colspan="8" >
                                <asp:Label ID="Label1" runat="server" Text="Recent Posted Ads" Font-Italic="true" Font-Size="19px" Font-Bold="true"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td align="center">
                                <asp:ImageButton ID="left" runat="server" ImageUrl="Images/left-arrow.png" OnClick="left_Click" />
                            </td>
                       <td align="center">
                           <asp:DataList ID="ddl" runat="server" RepeatColumns="6" RepeatDirection="Horizontal" 
                             onitemcommand="DataList1_ItemCommand2" DataKeyField="sid">
                             <ItemTemplate>
                               <table width="100%"  align="center"  >
                                   <tr>
                                      <td align="center" >
                                           <asp:ImageButton runat="server"  ID="Label1"  ImageUrl='<%#"ImageHandler.ashx?imgID="+ Eval("sid") %>'  
                                                             Height="140px" Width="180px" CommandArgument='<%# Eval("sid") %>' CommandName="aa" />
                                      </td>
                                  </tr>
                              </table>
                                 <br />
                            ...
                            <td align="center">
                                <asp:ImageButton ID="right" runat="server" ImageUrl="Images/right-arrow.png" OnClick="right_Click" />
                            </td>
                      </tr>
                    </table>
                </td>
                      ...
                      <table width="100%" >
                          <tr>
                              <td align="center"  width="25%">
                                  <asp:ImageButton ID="ImageButton11" runat="server" ImageUrl="Images/wawalive.png" OnClick="ImageButton11_Click" />
                              </td>
                              <td align="center" width="25%">
                                  <asp:ImageButton ID="ImageButton26" runat="server" ImageUrl="Images/indusemail.png" OnClick="ImageButton26_Click" />
                              </td>
                              <td align="center" width="25%">
                                  <asp:ImageButton ID="ImageButton18" runat="server" ImageUrl="Images/industravels.png" OnClick="ImageButton18_Click" />
                              </td>
                              <td align="center" width="25%">
                                  <asp:ImageButton ID="ImageButton19" runat="server" ImageUrl="Images/careerzen.png" OnClick="ImageButton19_Click" />
                              </td>
                            </tr>
                      </table>
                  </td>
