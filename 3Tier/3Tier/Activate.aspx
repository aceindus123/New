<%@ Page Title="" Language="C#" MasterPageFile="Default.Master" AutoEventWireup="true" CodeBehind="Activate.aspx.cs" Inherits="_3Tier.Activate" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <ajx:ToolkitScriptManager ID="as" runat="server"></ajx:ToolkitScriptManager>
        ...
        <table  class="body" align="center">
         ...
         <tr>
                <td align="center" class="body2" valign="middle">
                    
                       <br /> <br /><br /><br /><br /><br /> <h4>Click on Button Activate Your Account </h4>  <asp:ImageButton ID="img1" runat="server" ImageUrl="Images/Activate.png" OnClick="img1_Click" /> <br /> <br /><br /><br /><br /><br />
                </td>
            </tr>
    </table>
</asp:Content>
