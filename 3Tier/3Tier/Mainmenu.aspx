<%@ Page Title="" Language="C#" MasterPageFile="Default.Master" AutoEventWireup="true" CodeBehind="Mainmenu.aspx.cs" Inherits="_3Tier.Mainmenu" %>
                ...
                <td align="left" width="100%">
                                  ...
                                  <table align="center" width="80%">
                                      ...
                                      <tr>
                                        <td style="line-height:30px" align="left">
                                           <asp:Label ID="LinkButton11" runat="server" Text="Categories" Font-Underline="false" Font-Names="arial" Font-Size="19px"></asp:Label>
                                        </td>
                                    </tr>

                                    <tr>
                                        <td style="line-height:25px" align="left">
                                       &nbsp;    <asp:LinkButton ID="lnk1" runat="server" Text="All Ads" Font-Underline="false" Font-Names="arial" Font-Size="17px" OnClick="lnk1_Click"></asp:LinkButton>
                                        </td>
                                    </tr>
                                    <tr>
                                            ...
                                            <table width="100%" align="left" valign="top">
                                                <tr>
                                                   <td align="center" width="75%">
                                                        <asp:DataList ID="DataList1" runat="server" width="100%"  RepeatColumns="1"  Height="150px"
                                                                onitemcommand="DataList1_ItemCommand2"  >
                                                         <ItemTemplate>
                                                             <table width="100%"  align="center" Height="10px" >
                                                                 <tr>
                                                                      <td  align="left"  >  
                                                                        <asp:LinkButton ID="lbltitle1" runat="server" Text='<%# Eval("Category") %>'   Font-Underline="false" Font-Names="arial" 
                                                                            Font-Size="16px"  CommandName="sale" CommandArgument='<%# Eval("cid") %>'></asp:LinkButton>
                                                                     </td>
                                                                  </tr>
                                                              </table>
                                                             <br />
                                  ...
                                  <table width="80%" align="left">
                                    ...
                                    <tr>
                                        <td align="left" colspan="3">
                                            <asp:LinkButton ID="lbltitle" runat="server"  Font-Names="arial" Font-Underline="false" Font-Size="19px" OnClick="lbltitle_Click" ></asp:LinkButton>
                                        </td>
                                    </tr>
                                      <tr>
                                          <td>&nbsp;</td> 
                                       ...
                                       <tr>
                                        <td width="100%" align="left" valign="top">
                                            <table width="100%">
                                                <tr>
                                                   <td align="center" width="75%">
                                                        <asp:DataList ID="ddtop" runat="server" width="100%"  RepeatColumns="3" 
                                                     onitemcommand="DataList1_ItemCommand1" CellPadding="1" CellSpacing="0" Height="150px">
                                                     <ItemTemplate>
                                       
                                                       <table width="100%"  align="center" class="cattd" >
                                                           <tr>
                                                              <td align="center" class="tabletop">
                                                                  <asp:Image runat="server" ID="cimg1" ImageUrl='<%# Eval("cat_Image") %>'
                                                                      Height="77px" Width="65px"/>
                                                              </td>
                                                          </tr>
                                                          <tr>
                                                              <td class="catsubject" align="center"  >  
                                                                <asp:LinkButton ID="lbltitle" runat="server" Text='<%# Eval("SubCategory") %>'   Font-Underline="false" Font-Names="arial" Font-Size="15px"
                                                                     CommandName="sale" CommandArgument='<%# Eval("cid") %>'></asp:LinkButton>
                                                             </td>
                                                          </tr>
                                                      </table>
                                                         <br />
                  ...
                  <td width="98%"  align="left"  colspan="3">
                      <table width="100%" >
                          <tr>
                              <td align="center">
                                  <asp:ImageButton ID="ImageButton11" runat="server" ImageUrl="Images/aceindus.png" OnClick="ImageButton11_Click" />
                              </td>
                              <td align="center">
                                  <asp:ImageButton ID="ImageButton26" runat="server" ImageUrl="Images/indussms.png" OnClick="ImageButton26_Click" />
                              </td>
                              <td align="center">
                                  <asp:ImageButton ID="ImageButton18" runat="server" ImageUrl="Images/classified4dollar.png" OnClick="ImageButton18_Click" />
                              </td>
                              <td align="center">
                                  <asp:ImageButton ID="ImageButton19" runat="server" ImageUrl="Images/indusgroup.jpg" OnClick="ImageButton19_Click" />
                              </td>
                          </tr>
                      </table>
                  </td>
